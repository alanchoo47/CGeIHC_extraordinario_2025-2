...
int main()
{
	...
	// load models
	// -----------
	Model piso("resources/objects/piso/piso.obj");//Piso
	Model base1("resources/objects/Base/BaseCilindro.obj");//Base1
	Model base2("resources/objects/Base/BaseCilindro.obj");//Base2
	Model base3("resources/objects/Base/BaseCilindro.obj");//Base3
	Model Toroide1("resources/objects/Toroide1/Toroide1.obj");//Toroide1
	Model Toroide2("resources/objects/Toroide2/Toroide2.obj");//Toroide2
	Model Toroide3("resources/objects/Toroide3/Toroide3.obj");//Toroide3
